...
// Chapter 3 Tanks
local spots = ["will spawn just outside the first tunnel (~11%)","will spawn just outside the second tunnel (~26%)","will spawn just after the truck drop (~50%)","will spawn just outside the fiery train tunnel (~79%)"]
