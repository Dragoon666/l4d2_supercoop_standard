Msg("l4d_deathaboard05_light_finale-------------------------------------------------------\n");
ERROR <- -1
PANIC <- 0
TANK <- 1
DELAY <- 2
...
DirectorOptions <-
{
	D_CustomFinale_StageCount = 12
	 ...
	 D_CustomFinaleValue4 = "l4d_deathaboard05_light_on.nut" 
	 ...
	 D_CustomFinaleValue8 = "l4d_deathaboard05_light_on.nut"
	 ...
	 D_CustomFinaleValue12 = "l4d_deathaboard05_light_on.nut"
