...
// Chapter 2 Witches
local spots = ["will spawn just before the silos (~15%)", "will spawn on the catwalks of the container room (~26%)", "will spawn just after the first set of drain pipes (~75%)"]
