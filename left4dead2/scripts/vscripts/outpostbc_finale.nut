...
function AbortDelay(){}  	// only defined during a delay, in outpostbc_delay.nut
function EndDelay(){}		// only defined during a delay, in outpostbc_delay.nut
...
{
	printl( "Beginning outpostbc finale stage " + num + " of type " + type );
