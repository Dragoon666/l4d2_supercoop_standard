...
// Base DirectorOptions
{
	...
	A_CustomFinaleValue1 = "" //InitialOnslaughtOptions is slightly different from re3m8_delay
 
	A_CustomFinale2 = PANIC
	A_CustomFinaleValue2 = 1 //1 PANIC wave
 
	A_CustomFinale3 = ONSLAUGHT
	A_CustomFinaleValue3 = "re3m8_delay" //This onslaught also depends on timer
 
	A_CustomFinale4 = PANIC
	A_CustomFinaleValue4 = 1
 
	A_CustomFinale5 = ONSLAUGHT
	A_CustomFinaleValue5 = "re3m8_delay"
...
function AbortDelay(){}  	// only defined during a delay, in re3m8_delay.nut
function EndDelay(){}		// only defined during a delay, in re3m8_delay.nut
...
// Evaluate the number of times gas cans poured or touched
{
    ...
    // This is for re3m8_delay.nut (re3m8_delay.nut also resets the counter for Poured and TouchOrPoured)
    {
        AbortDelay()
    }
