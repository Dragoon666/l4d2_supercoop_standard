...
class SongList {
	...
	constructor( _songs, _menu_model, _skin_start, _horde_timer )
	{
		songs = _songs
...
NormalSongList <- SongList( EntityGroup.slice(1, 5+1 ), EntityGroup[8], 2, EntityGroup[6] ) // 5 songs, skins start at 2
RareSongList <- SongList( EntityGroup.slice(10, 10+1 ), EntityGroup[8], 6, EntityGroup[6] ) // 1 song, skin starts at 6
